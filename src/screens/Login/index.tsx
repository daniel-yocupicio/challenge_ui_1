...
import { RootStackParamsNavigator } from '../../navigation/StackNavigator';
...
const Login : FC = () => {
  const {hideBackground2, showBackground2} = useContext(UIContext);
  ...
  const navigationGlobal = useNavigation<NavigationProp<RootStackParamsNavigator>>();
